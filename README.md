# A minimum DPDK forwarding implementation

## Features
1. Full speed L2fwd capability
2. Throughput statistics
3. Flow rule steering capability
4. default RSS capability
...
```
This works perfect on my machine with MLX CX-5 CCAT 100G card.
